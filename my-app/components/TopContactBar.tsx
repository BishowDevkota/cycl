...
// Shared container — guarantees pixel-perfect left/right alignment across both bars
    ...
    <>
      ...
      <div className="sticky top-0 z-50 w-full border-b border-zinc-200/80 bg-white shadow-[0_8px_22px_rgba(7,100,110,0.12)]">
        <div className={`${row} min-h-20`}>
          ...
          {/* Navigation Links + Career Button */}
        ...
        {/* Mobile Dropdown */}
        {mobileMenuOpen && (
          <div className="border-t border-zinc-200 px-6 py-4 xl:hidden xl:px-10">
