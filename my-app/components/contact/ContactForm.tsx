...
export function ContactForm() {
  ...
  return (
    <form
      ...
      noValidate
      className=" border border-[#d5e4ec] bg-white p-5 shadow-[0_18px_36px_rgba(16,53,74,0.08)] sm:p-6"
    >
      ...
      <div className="mt-5 space-y-4">
        ...
        <label className="block">
          ...
          <input
            ...
            className="w-full g border border-[#c9dce5] px-3 py-2.5 text-sm text-slate-800 outline-none transition focus:border-[#0d837f] focus:ring-2 focus:ring-[#0d837f]/20"
      ...
      {submitError && (
        <p className="mt-4 -lg border border-red-200 bg-red-50 px-3 py-2 text-sm text-red-700">
          {submitError}
        </p>
      )}

      {successMessage && (
        <p className="mt-4 border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-700">
          {successMessage}
        </p>
      )}
